...
// Copyright (c) 2013 Num2coin developers
...
const string strMessageMagic = "Num2coin Signed Message:\n";
...
static const int64 nTargetTimespan = 180; // 3 minutes
static const int64 nTargetSpacing = 36; // 5 blocks
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 2 blocks

static const int64 nAveragingInterval = nInterval * 5; // 5 blocks
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("Num2coinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("Num2coinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running Num2coinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("Num2coinMiner terminated\n");
        throw;
    }
}
